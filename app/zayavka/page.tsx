...
import { User, Calendar, Building2, Phone, Briefcase, Mail, Users } from "lucide-react";
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-6">
            ...
            {isEstablishment ? (
              <>
                ...
                <section className="space-y-4" aria-labelledby="zayavka-contacts-establishment-heading">
                  <h2 id="zayavka-contacts-establishment-heading" className="text-sm font-semibold text-[var(--color-text)] border-0 pb-2">
                    Контакты
                  </h2>
                  <div>
