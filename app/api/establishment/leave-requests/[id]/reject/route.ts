/**
 * POST /api/establishment/leave-requests/[id]/reject — отклонить заявку на выход (официант остаётся в заведении).
 */
...
export async function POST(request: NextRequest, { params }: Params) {
  ...
  const updated = await db.employeeLeaveRequest.updateMany({
    where: {
      id: requestId,
