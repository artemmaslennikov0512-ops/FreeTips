  ...
  if (result === "success") {
    return (
      <div className="mx-auto flex min-h-[60vh] max-w-md flex-col items-center justify-center px-4 text-center">
        ...
        <p className="mt-2 text-[var(--color-text-secondary)]">{recipientName} получил вашу благодарность.</p>
        <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
          <button
            ...
            className="rounded-xl border-0 bg-[var(--color-accent-gold)]/10 px-5 py-2.5 text-sm font-medium text-[var(--color-text)] hover:bg-[var(--color-accent-gold)]/20 focus-visible:outline-none"
          >
            Отправить ещё
          </button>
          <Link
            href="/"
            className="rounded-xl bg-[var(--color-accent-gold)] px-5 py-2.5 text-[var(--color-navy)] font-semibold hover:opacity-90 focus-visible:outline-none"
          >
            На главную
          </Link>
        </div>
