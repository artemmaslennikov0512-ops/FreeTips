/**
 * Общая логика POST для Paygine webhook (/api/payment/webhook и /api/v1/webhooks/paygine).
 */
...
export async function postPaygineWebhook(request: NextRequest, routePathForLog: string): Promise<NextResponse> {
