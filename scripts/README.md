...
По умолчанию: 50 платежей, 3 потока. Быстрая проверка: `5 1`. Ещё выше нагрузка: `100 5`. Нужны приложение (BASE_URL, вебхуки должны доходить), DATABASE_URL, Paygine и тестовая карта в scripts/.env. `HEADLESS=0` — показать браузер.
