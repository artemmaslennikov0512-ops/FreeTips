...
export function PayTelegramSupportBlock({ className = "", variant = "embedded" }: Props) {
  ...
  const inner = (
    <>
      ...
      <p className="pay-support-callout-body">
        Напишите нам в Telegram. Проверим операцию в системе и быстро приведём всё в порядок: вернём лишнее,
        скорректируем сумму или подскажем следующий шаг. Работаем 24/7.
      </p>
      <a
