      ...
      <div className="mt-12 space-y-8 text-[var(--color-text-secondary)]">
        ...
        <section>
          ...
          <div className="mt-2 space-y-2">
            ...
            <p>
              Для инициации возврата необходимо направить заявку на адрес электронной почты: <a href="mailto:tippingserviceft@mail.ru" className="text-[var(--color-accent-gold)] hover:opacity-90 hover:underline">tippingserviceft@mail.ru</a>. В заявке укажите дату и сумму перевода, способ перевода (карта / мобильный платёж) и причину возврата. Оператор рассмотрит обращение в срок до 10 рабочих дней и сообщит о решении.
            </p>
            <p>
