...
export function PayTelegramSupportBlock({ className = "", variant = "embedded" }: Props) {
  ...
  const inner = (
    <>
      <h2 id={titleId}>Проблема с оплатой?</h2>
      <p>
        Если списалась неверная сумма, платёж прошёл дважды или что-то пошло не так — сначала напишите нам в
        Telegram. Мы проверим операцию в системе и быстро приведём всё в порядок: вернём лишнее, скорректируем
        сумму или подскажем следующий шаг.
      </p>
      <p>
        Так вы получите ответ быстрее, чем через обращение в банк, и мы сможем сразу исправить ситуацию с нашей
        стороны.
      </p>
      <a
