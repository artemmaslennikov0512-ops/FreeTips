...
- **Размещение APK:** `npm run copy-apk` → `public/freetips.apk` (ссылка на сайте: `/freetips.apk`).
...
## Push-синхронизация операций

Актуальная архитектура и гарантии по push/отметкам описаны в `docs/ANDROID_PUSH_SYNC.md`.
