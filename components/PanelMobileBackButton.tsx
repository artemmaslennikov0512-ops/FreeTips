...
export type PanelMobileBackVariant = "admin" | "cabinet" | "establishment" | "testLkMock";
...
export function PanelMobileBackButton({
  ...
  return (
    <div className={`shrink-0 lg:hidden ${variant === "testLkMock" ? "" : "border-b border-white/10"}`} style={rowStyle}>
