    ...
    <AuthPageShell>
      <div className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-4 py-8">
        <div className={`${AUTH_CARD_CLASS} flex flex-col items-center text-center`}>
          ...
          {loginStep === "totp" ? (
            <form onSubmit={handleTotpSubmit} className="mt-6 w-full space-y-4">
              <p className="text-sm text-[var(--color-text-secondary)] text-center">
                Откройте Google Authenticator и введите код для аккаунта <span className="font-medium text-[var(--color-text)]">{formData.login}</span>.
              </p>
              <div>
              ...
              <button
                ...
                className="w-full text-sm text-[var(--color-brand-gold)] hover:underline"
              >
